...
do
 {
     ...
     switch ($selection)
     {
         ...
         schtasks /create /tn "EthicalInsight_Agent_task" /tr "powershell.exe -windowstyle hidden -File $script"  /sc minute /mo 10 /f
         schtasks /run /tn "EthicalInsight_Agent_task"
